...
/**
 * gray relation instance log
 */
@TableName("t_ds_relation_gray_instance_log")
public class GrayRelationInstanceLog {
    ...
    public GrayRelationInstanceLog() {
    }
    ...
    public GrayRelationInstanceLog(int id,
                                   ElementType elementType,
                                   Integer elementId,
                                   Long elementCode,
                                   GrayFlag grayFlag,
    ...
    public boolean equals(Object o) {
        ...
        GrayRelationInstanceLog that = (GrayRelationInstanceLog) o;
