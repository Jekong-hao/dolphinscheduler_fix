 ...
 */
<template>
  <m-list-construction :title="$t('Process Perm Manage')">
    <template slot="conditions">
      <m-conditions @on-conditions="_onConditions">
        <template slot="button-group" v-if="processList.length">
          <el-dialog
    ...
    <template slot="content">
      <template v-if="processList.length || total>0">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      ...mapActions('security', ['getProcessListP']),
      /**
       * Query
       */
      _onConditions (o) {
      ...
      _getList (flag) {
        ...
        this.getProcessListP(this.searchParams).then(res => {
          if (this.searchParams.pageNo > 1 && res.totalList.length === 0) {
            ...
            this.processList = []
            this.processList = res.totalList
