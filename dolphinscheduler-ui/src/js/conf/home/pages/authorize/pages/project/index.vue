 ...
 */
<template>
  <m-list-construction :title="$t('Project Perm Manage')">
    <template slot="conditions">
      <m-conditions @on-conditions="_onConditions">
        <template slot="button-group" v-if="projectList.length">
          <el-dialog
    ...
    <template slot="content">
      <template v-if="projectList.length || total>0">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      ...mapActions('security', ['getProjectListP']),
      /**
       * Query
       */
      _onConditions (o) {
      ...
      _getList (flag) {
        ...
        this.isLoading = !flag
        this.getProjectListP(this.searchParams).then(res => {
